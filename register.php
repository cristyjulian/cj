...
<body>
<?php
        include 'connect.php'; // Ensure this path is correct for your connection script
        if (isset($_POST['register'])) {
            ...
            if ($password !== $confirm_password) {
                ...
                $userCheck = $conn->prepare("SELECT username FROM teachusers WHERE username = ?");
                ...
                if ($result->num_rows > 0) {
                    ...
                    $sql = "INSERT INTO teachusers (name, username, password) VALUES (?, ?, ?)";
